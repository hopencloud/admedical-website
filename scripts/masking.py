...
[제거 대상 1 — 병원 식별 정보 (광고를 보고 어느 병원인지 알 수 있는 모든 단서)]
- 한국어 의료기관명 (OCR 오류로 깨진 형태도 포함):
  예: "강북보아스이비인후과", "애플비뇨기과의원", "봄봄이비인후과", "차앤유의원", "차앤유의훤"
  → "이비인후과", "비뇨기과의원" 같이 고유명사 빠진 일반 명칭은 남겨도 됨.
  → 단, 단독으로 등장한 "봄봄", "BORNBOM" 같은 브랜드 토막도 제거.
- 영문 의료기관명/브랜드:
  예: "PANGYO SAEROTNTN REHABILITATION CLINIC", "SHINE BEAM", "BORNBOM"
- 의료진 이름과 직함:
  예: "김철수 원장", "유종호 박사", "27년경력 대표원장 유종호"
- 전화/팩스 — 숫자-숫자 패턴은 무조건 제거:
  예: "031-212-1912", "02-1234-5678", "1588-XXXX", "055 282-2222", "010-XXXX-XXXX"
- 주소/지번/도로명:
  예: "경남 창원시 성산구 외동반림로 126번길56", "서울시 강남구 테헤란로 123"
- 위치/장소 안내:
  예: "판교역 1번 출구", "OO몰 2층", "멜포트몰 2층", "OO상가", "OO 로타리", "OO 오거리", "이마트", "중앙시장", "중앙파출소"
- 홈페이지/이메일/SNS:
