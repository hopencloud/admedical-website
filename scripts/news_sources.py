...
MARKETING_CORE = [
    ...
    # 표시·가격 (광고 문구에 직결)
    # "진료비" 만 두면 '진료비 심사'(보험 청구 심사) 에도 걸린다. 광고와 무관하다.
    "비급여", "진료비 공개", "진료비 표시", "가격 표시", "표시 의무", "가격 공개",
    # 채널
    ...
    # 시장
    # 진료과·시술 이름만 두면 임상 기사가 다 통과한다
    # ("팔 안쪽 전층피부이식" 이 '피부' 로 걸렸다). 광고 맥락이 붙은 것만 둔다.
    "개원", "폐업", "환자 유치", "비급여 광고", "미용 광고",
]
